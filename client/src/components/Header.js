...
const Header = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const shouldShow =
        scrolledPast && !menuOpen && contentVisibleFlag && !footerVisible;
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const rect =
              entry.boundingClientRect || footerEl.getBoundingClientRect();
            const viewportH =
  ...
  return (
    <>
          ...
          >
            ...
            <Link to="/" className="flex-shrink-0">
              <div className="flex items-center gap-3 group cursor-pointer">
                ...
                <span
                  className={`${linkColor} font-bold text-2xl tracking-wider`}
                >
                  ListWithLeatonic
                </span>
              </div>
        ...
        {menuOpen && (
          <div className="fixed inset-0 bg-black z-[60] flex flex-col items-center justify-center animate-fadeIn overflow-y-auto py-20">
            ...
            <div className="mb-12">
              ...
              <span className="text-white font-bold text-2xl mt-4 block text-center">
                ListWithLeatonic
              </span>
            </div>
      ...
      {showBottomVisible && (
        <div
          className="fixed left-4 right-4 sm:left-1/2 sm:right-auto sm:transform sm:-translate-x-1/2"
          style={{ bottom: `${bottomOffset}px`, zIndex: 80 }}
        >
          <div
            className="backdrop-blur-md rounded-lg px-4 py-3 flex items-center gap-4 shadow-xl mx-auto"
            style={{
          ...
          >
            ...
            <Link
              to="/contact"
              className="bg-black text-white px-4 py-2 rounded-2xl font-semibold shadow-md text-sm"
            >
              Contact
            </Link>
          </div>
